...
- **Histograms** show the counts (frequency) of values in each range (bin), represented by the height of the bars. Can be useful if there is a great difference between the different groups. 
...
# factors lets you have levels to character strings different than the r default which is alphabetical
mko_clean |> 
