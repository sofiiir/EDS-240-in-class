...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm)) +
  ...
  scale_color_manual(values = c('#1F1A38', "darkorange", "#5F7470"))
...
ggplot(penguins, aes(x = bill_length_mm, y = bill_depth_mm, color = body_mass_g)) + 
  geom_point() +
  scale_color_gradient(low = "#D77A61", high = "#273E47")
```
...
ggplot() + 
  geom_point(data = penguins, mapping = aes(x = bill_length_mm, 
                                            ...
                                            color = species),
             alpha = 0.5) +
  geom_point(data = penguins_summary, mapping = aes(mean_bill_length_mm, 
                                   mean_bill_depth_mm, 
                                   fill = species),
             size = 5,
             shape = 24
...
ggplot(penguins, aes(x = bill_length_mm, 
                     y = bill_depth_mm, 
                     color = species)) + # data is being grouped
  geom_point() +
...
ggplot(penguins, aes(x = species, fill = island)) +
  geom_bar(position = "dodge") +
    scale_fill_manual(values = c('#1F1A38', "darkorange", "#5F7470"))
```
...
ggplot(penguins, aes(x = species)) +
  ...
  theme_light() +
  theme(
    axis.title = element_text(size = 17, colour = "hotpink")
  )
```
...
ggplot(penguins, aes(x = flipper_length_mm, fill = species)) +
  ...
  scale_fill_manual(values = c('#1F1A38', "#ED6A5A", "cyan4")) +
  labs(x = "Flipper Length (mm)",
       y = "Frequency",
       fill = "Species",
       title = "Penguins Flipper Length") +
...
(p1 + (p2/p3)) +
  plot_annotation("All the greatest info on penguins")
```