...
RColorBrewer::display.brewer.pal(n = 3, name ="PiYG")

# print the HEX codes of your palette ----
RColorBrewer::brewer.pal(n = 3, name = "PiYG")

# or save hex codes as a vector ----
my_brewer_pal <- RColorBrewer::brewer.pal(n = 3, name = "PiYG")
```
...
# Accessibility tip: add a black line to circles
...
con_color_plot +
  scale_color_gradientn(colors = pal_c) # use gradientn so that it uses all the colors
